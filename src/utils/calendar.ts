...
export const FIXED_CALL_SCHEDULE: ScheduledCall[] = [
  {
    ...
    host: "Equipe Adsata",
    description: "Definição de prioridades e metas de tráfego para a semana.",
  },
  {
    id: "sched-quarta",
    ...
    dayShort: "QUA",
    time: "16:00",
    topic: "Revisão de Meio de Semana",
    host: "Equipe Adsata",
    description: "Análise de métricas e ajustes nas campanhas em andamento.",
  },
  {
    id: "sched-sexta",
    ...
    dayShort: "SEX",
    time: "16:00",
    topic: "Fechamento da Semana",
    host: "Equipe Adsata",
    description: "Resultados da semana e planejamento dos próximos passos.",
  },
];
